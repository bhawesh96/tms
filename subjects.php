 ...
 <div class='header'>
	  ...
	  <div class='container-fluid'>
		...
		<div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
		  <ul class='nav navbar-nav'>
			...
			<li class='dropdown'>
			  <a href='#' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>Accredetations <span class='caret'></span></a>
			 ...
			 <li><a href='gallery.html'>Gallery</a></li>
			  <li><a href='typo.html'>Chapters</a></li>
	...
	<!-- start search-->
		...
		<div class='logo'>
			...
			<a href='index.html'><img src='images/logo.png' alt=''><span>THE</span> MATHITIS SOCIETY</a>
	    </div>
		<div class='banner'>
			<h1>EDUCATE <span> EQUIP </span> ENABLE</h1>
			<!-- <h2>ENABLE</h2> -->
		</div>
	</div> 
</div>			
	<!--content-->
	<div class='content CRIBBL Services-agile'>
		<div class='container'>
...
if(mysql_num_rows($result) > 0) {
    ...
    while($row = mysql_fetch_assoc($result)) {
        $img_link[i] = $row['image'];
        $subject_name[i] = $row['subject_name'];
        $description[i] = $row['description'];
        $imgval = base64_encode($img_link[i]);
        
  print "
  <a href='companies.php?subject=$subject_name[i]'>
	<div class='col-md-4 content-top1'>
		<!-- <img src='$img_lin' class='img-responsive' alt=''> -->
		<img class='img-responsive' src='data:image/jpg;base64,$imgval' />
		<div class='content-plan'>
			<h6><a href='companies.php?subject=$subject_name[i]'>$subject_name[i]</a></h6>
			<p>$description[i]</p>
		</div>
...
?>
			...
			<div class='container'>
				...
				<div class='feature-grid'>
					<div class='col-md-4 feature-grid'>
						<h5><a href='single.html'>Event 1</a></h5>
						<div class=' fe-grid'>
					...
					<div class='col-md-4 feature-grid'>
						<h5><a href='single.html'>Event 2</a></h5>
						<div class=' fe-grid'>
							<i class='glyphicon glyphicon-map-marker'></i>
							<div class='feature-text'>
								<p>Tempor Street Lorem ipsum dolor,
					...
					<div class='col-md-4 feature-grid'>
						<h5><a href='single.html'>Event 3</a></h5>
						<div class=' fe-grid'>
							<i class='glyphicon glyphicon-map-marker'></i>
							<div class='feature-text'>
								<p>Tempor Street Lorem ipsum dolor,
		...
		<!--map-->
			<div class='map-top CRIBBL Services-agile'>
	...
	<!--//content-->
<!--footer-->
	<div class='footer CRIBBL Services-agile'>
				<div class='container'>
					<p class='footer-class'>&copy; TMS, Manipal. All Rights Reserved | Design by  <a href='http://cribblservices.esy.es' target='_blank'>CRIBBL Services</a> </p>
					<section id='set-9'>
